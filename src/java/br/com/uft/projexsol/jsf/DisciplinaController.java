...
import br.com.uft.projexsol.entities.Disciplina;
import br.com.uft.projexsol.jsf.util.JsfUtil;
import br.com.uft.projexsol.jsf.util.JsfUtil.PersistAction;
import br.com.uft.projexsol.jpa.session.DisciplinaFacade;
...
public class DisciplinaController implements Serializable {
    ...
    @EJB
    private br.com.uft.projexsol.jpa.session.DisciplinaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("DisciplinaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("DisciplinaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("DisciplinaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
