...
import br.com.uft.projexsol.jpa.session.DocenteFacade;
...
public class DocenteController implements Serializable {
    ...
    @EJB
    private br.com.uft.projexsol.jpa.session.DocenteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("DocenteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("DocenteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("DocenteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
