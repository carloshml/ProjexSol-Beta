...
import br.com.uft.projexsol.jpa.session.ProjetoFacade;
...
public class ProjetoController implements Serializable {
    ...
    @EJB
    private br.com.uft.projexsol.jpa.session.ProjetoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("ProjetoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("ProjetoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("ProjetoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
