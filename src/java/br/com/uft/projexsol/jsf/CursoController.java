...
import br.com.uft.projexsol.jpa.session.CursoFacade;
...
public class CursoController implements Serializable {
    ...
    @EJB
    private br.com.uft.projexsol.jpa.session.CursoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("CursoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("CursoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("CursoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
