...
public class VoluntarioEnsino extends Voluntario implements Serializable {
    ...
    public VoluntarioEnsino(Curso curso, Departamento departamento, Integer id, String ativo, String nome, int codigo, String cpf, String rg, String login, String senha, String telefone, String celular, String email, Endereco endereco, List<AreaDeInteresses> areasDeInteresses) {
